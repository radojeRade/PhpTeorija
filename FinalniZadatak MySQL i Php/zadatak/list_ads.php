...
<?php
                ...
                $sql = "SELECT p.id, p.title, p.content, p.category, p.created_at, p.expires_on, u.email
                FROM ads as p 
            ...
            ?>
                    ...
                    <article class="va-c-article">
                        <header>
                            ...
                            <div class="va-c-article__meta"><?php echo($ad['created_at']) ?> by <?php echo($ad['first_name']) ?></div>
                        </header>
